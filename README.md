...
Clicking on said child will reveal the awesome modal that should work once all your contracts are deployed to the chain with the correct vuln_id. The only step left now is connecting that sweet $Bling-Bling$ that is your MetaMask wallet.
